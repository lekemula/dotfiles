...
gem update --system
gem update solargraph solargraph-rspec ruby-debug-ide ripper-tags gem-ripper-tags vernier profile-viewer bundle_update_interactive churn rails-mcp-server
npm update -g
